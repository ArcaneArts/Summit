...
import 'data/provider/network_provider_util.dart' as _i3;
...
import 'data/user/user_repository.dart' as _i9;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i3.NetworkProviderUtil>(() => _i3.NetworkProviderUtil(
      name: get<String>(),
      secure: get<bool>(),
      port: get<int>(),
      address: get<String>()));
  ...
  gh.factory<_i10.HomeBloc>(() => _i10.HomeBloc(get<_i6.ServerRepository>()));
  return get;
}
