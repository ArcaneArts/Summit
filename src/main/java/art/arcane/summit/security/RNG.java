...
public class RNG extends Random {
    private static final char[] CHARGEN_SIMPLE = "1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".toCharArray();
    ...
    public char cs() {
        return CHARGEN_SIMPLE[i(CHARGEN_SIMPLE.length - 1)];
    }
